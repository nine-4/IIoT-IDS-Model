...
# Alani's 11 features
selected_features = ['DIntPkt', 'sTtl', 'IdleTime', 'SIntPkt', 'DstBytes', 'pLoss',
                     'SrcLoad', 'SrcPkts', 'Load', 'DstLoad', 'Traffic', 'Target',
                     'Dport_wellknown', 'Dport_registered', 'Dport_dynamic']
...
train_11.to_csv("training_data_11.csv", index=False, float_format="%.10f")
test_11.to_csv("testing_data_11.csv", index=False, float_format="%.10f")
